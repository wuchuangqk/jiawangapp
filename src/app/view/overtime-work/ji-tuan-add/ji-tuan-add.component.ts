...
@Component({
  selector: 'app-ji-tuan-add',
  templateUrl: './ji-tuan-add.component.html',
  styleUrls: ['./ji-tuan-add.component.scss'],
})
export class JiTuanAddComponent extends BasePage implements OnInit {
  @Input() index;
...
/*    this.username = userInfo.name;
  ...
  private checkParams(params): boolean {
    if (!params.jbtime) {
      ...
      this.dialogService.toast('请选择集团公司分管领导!');
      return false;
    }
    /*if(this.type===0){
