export class HomeModel {
    public static itemList = [
        { icon: 'ios-notifications', color: '#7dc6ff', name: 'notice', title: '通知公告', url: '/notices/list', bage: '' , addUrl: 'add' },
        ...
        { icon: 'ios-chatbubbles', color: '#7dc6ff', name: 'notice', title: '工作交流', url: '/work_dynamics/list', addUrl: 'exchange-add' },
