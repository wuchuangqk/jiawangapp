...
@Component({
  ...
  templateUrl: './tu-di-guan-li-detail.component.html',
  styleUrls: ['./tu-di-guan-li-detail.component.scss'],
})
export class TuDiGuanLiDetailComponent extends DetailBasePage implements OnInit {
  public title = '详情';
