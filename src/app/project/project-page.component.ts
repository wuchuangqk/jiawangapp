...
export class ProjectPage extends  BasePage {
  ...
  public itemList = [
    ...
    { icon: 'ios-briefcase', color: '#7dc6ff', name: 'project/my-project', title: '我的项目' },
    { icon: 'ios-bookmarks', color: '#fb8862', name: 'project-management', title: '项目管理' },
    { icon: 'ios-create', color: '#b2d76a', name: 'project/xiang-mu-jin-du', title: '项目进度' },
    // { icon: 'ios-pricetags', color: '#89d4af', name: 'TouZiBaoBiaoPage', title: '工程审批'},
    { icon: 'ios-pricetags', color: '#f9a970', name: 'project/my-shen-pi-list', title: '我的审批' },
